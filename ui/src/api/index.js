...
export const fetchUsers = (query) => API.get(`/api/users?${qs.stringify(query)}`)
...
export const fetchProducts = (query) => API.get(`/api/products?${qs.stringify(query)}`);
...
export const fetchOrders = (query) => API.get(`/api/orders?${qs.stringify(query)}`);
